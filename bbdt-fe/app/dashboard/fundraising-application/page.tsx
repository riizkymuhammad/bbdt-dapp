...
export default function FundraisingApplicationPage() {
    ...
    const handleNewApplication = () => {
        router.push("/dashboard/fundraising-application/create")
    }
  ...
  try {
    ...
    const coverImageFile = form.getValues('coverImage')
    if (!coverImageFile) {
      toast({
        variant: "destructive",
        title: "Error",
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h2 className="text-3xl font-bold tracking-tight">Kelola Penggalangan Dana</h2>
